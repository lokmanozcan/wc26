// src/fifaMatrix.js
// 2026 FIFA Dünya Kupası - Annex C Tam Lookup Tablosu (495 Kombinasyon)
//
// Slot sırası (index 0-7) — Wikipedia Annex C sütun sırasıyla:
//   0: → 1A liderine karşı (Match 79)
//   1: → 1B liderine karşı (Match 85)
//   2: → 1D liderine karşı (Match 81)
//   3: → 1E liderine karşı (Match 74)
//   4: → 1G liderine karşı (Match 82)
//   5: → 1I liderine karşı (Match 77)
//   6: → 1K liderine karşı (Match 87)
//   7: → 1L liderine karşı (Match 80)
//
// Anahtar: nitelik kazanan 8 grubun harfleri alfabetik sırayla (örn: "ABCDEFGH")
// Değer: her slota atanan grup harfi [slot0, slot1, slot2, slot3, slot4, slot5, slot6, slot7]
...
const FIFA_ANNEX_C = {
  ...
  "ABCEFJKL": ["C", "J", "B", "E", "A", "F", "L", "K"],
  "ABCEFIKL": ["C", "E", "B", "F", "A", "I", "L", "K"],
  "ABCEFIJL": ["C", "J", "B", "E", "A", "F", "L", "I"],
  "ABCEFIJK": ["C", "J", "B", "E", "A", "F", "I", "K"],
  ...
  "ABCEFGKL": ["C", "G", "B", "E", "A", "F", "L", "K"],
  "ABCEFGJL": ["C", "G", "B", "E", "A", "F", "L", "J"],
  "ABCEFGJK": ["C", "G", "B", "E", "A", "F", "J", "K"],
  "ABCEFGIL": ["C", "G", "B", "E", "A", "F", "L", "I"],
  "ABCEFGIK": ["C", "G", "B", "E", "A", "F", "I", "K"],
  "ABCEFGIJ": ["C", "G", "B", "E", "A", "F", "I", "J"],
  ...
  "ABCDEFGH": ["C", "G", "B", "D", "A", "F", "E", "H"]
};

/**
 * @param {string} qualifiedLetters - Alfabetik sıralı 8 harf (örn: "ABCDEFGH")
 * @param {number} slotIndex - 0-7 arası slot indeksi
 * @returns {string} O slota atanan grup harfi
 */
export function getFifaTargetThird(qualifiedLetters, slotIndex) {
